...
public class Teclado extends JPanel implements ActionListener {
	...
	private final Color COR_CINZA = new Color(99, 99, 99);
	...
	public Teclado() {
		...
		//Linha 1
		c.gridwidth = 2;//Todas as contrains para baixo vão ter a largura 3
		adicionarBotao("AC", COR_CINZA_ESCURO, c, 0, 0);
		c.gridwidth = 1;//Votando as contrains para larura 1
		...
		//Linha 4
		adicionarBotao("1", COR_CINZA, c, 0, 3);
		adicionarBotao("2", COR_CINZA, c, 1, 3);
		adicionarBotao("3", COR_CINZA, c, 2, 3);
